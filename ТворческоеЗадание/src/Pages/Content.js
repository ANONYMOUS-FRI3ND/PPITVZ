        ...
        if (error) {
            ...
            return (<>
                ...
                <div className="content">
                    <div id="message-load" className={"LoadingScreen"}>Loading... Please wait.</div>
                </div>
                <Footer/>
            </>)
        } else {
            return (
                <>
                    <Header number="1"/>
                    <a href="#" title="UP" className="UP">UP</a>
                    <div className="content">
                        <div className="search">
                            <label>Search <input type={"text"} onKeyPress={this.changeSearch} id="search"/> </label>
                            Sort by:
                            <ul>
                                <li><u>Name</u></li>
                                <li><u>Date</u></li>
